...
- Script: `src/virksomhed_api_call.py`
...
```py
# Download all data at once (may timeout for very large datasets)
python virksomhed_api_call.py

# Download in batches by founding year (recommended for reliability)
# The years are inclusive (e.g. 1800-1990 includes from Jan 1st 1800 to Dec 31st 1990)
...
python virksomhed_api_call.py --format "parquet"

# Output mode: panel (default, multiple files) or wide (single flat file)
